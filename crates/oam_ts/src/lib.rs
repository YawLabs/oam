...
///
/// Twin of `oam_loader::tsconfig::info_for_with` (the loader's nearest-
/// tsconfig walk for `paths`/`jsxImportSource`): same upward walk, kept as
/// two copies on purpose so oam_ts does not depend on the loader crate.
